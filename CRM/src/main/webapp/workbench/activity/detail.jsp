...
<script type="text/javascript">
	...
	$(function(){
		...
		/*展现市场活动备注信息，在页面加载完成后局部刷新，显示备注信息*/
		getNoteDetail();
	...
	function getNoteDetail() {
		//ajax请求
		$.ajax({
			url:"workbench/activity/getNote.do",
			data:{
			...
			success:function (data) {
				/*这里需要的数据是市场活动备注信息列表*/
				//{备注1，备注2，，，}，循环遍历data，并且在页面展示信息

				var html = "";
				$.each(data,function (i,n) {
					/*这里做字符串拼接操作，保证一行是一个语句*/
...
<body>
	...
	<div id="remarkBody" style="position: relative; top: 30px; left: 40px;">
		...
		<%--！！！！！！！！！！！！！！！！！！！！！！！--%>
		<%--这里展示页面信息有两种方法，1：新建一个div，赋值id后绑定id属性调用函数；2:使用append函数追加在上一个div后面或者使用before函数追加在后一个div前面--%>
